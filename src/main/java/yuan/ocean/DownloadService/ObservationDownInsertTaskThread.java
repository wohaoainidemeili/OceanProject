 ...
 */
public class ObservationDownInsertTaskThread implements Runnable {
    ...
    public ObservationDownInsertTaskThread(String url,String property,String stationIDFile,String linkedFile,
